...
This repository owns the original Module Layout runtime. Its first immutable baseline also preserves Cable Geometry Visualiser and DC/AC/LV Topology Review as separate sibling components until they receive dedicated owners. GIS SLD Financial Sandbox belongs to `Ventusltd/unnamed-01` and is not duplicated here.
